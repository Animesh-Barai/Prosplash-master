package com.aork.main.ui.following.adapter.holder;
...
import com.aork.common.ui.widget.CircularProgressIcon;
import com.aork.common.ui.widget.CoverImageView;
import com.aork.common.ui.widget.longPressDrag.LongPressDragCardView;
import com.aork.main.R;
import com.aork.main.R2;
import com.aork.main.ui.following.adapter.FollowingAdapter;
import com.aork.main.ui.following.adapter.model.FollowingModel;
import com.aork.main.ui.following.adapter.model.PhotoFeedModel;
...
public class PhotoFeedHolder extends FollowingHolder {
    ...
    public void onBindView(FollowingModel model, boolean update) {
        ...
        if (photoFeedModel.downloading) {
            ...
            downloadButton.setResultState(R.drawable.ic_download);
        }
        ...
        if (photoFeedModel.likeProgressing) {
            ...
            likeButton.setResultState(
                    photoFeedModel.liked ? com.aork.common.R.drawable.ic_like_active_icon_with_border : com.aork.common.R.drawable.ic_like_inactive_icon_with_border);
        }
